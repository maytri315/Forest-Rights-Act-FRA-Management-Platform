...
class NERService:
    ...
    def extract_entities(self, text: str) -> Dict[str, Any]:
        ...
        try:
            ...
            # Use transformer model for better person name detection
            if self.transformer_ner:
                transformer_entities = self._extract_with_transformer(text)
                entities["person_names"].extend(transformer_entities.get("person_names", []))
    ...
    def _extract_with_transformer(self, text: str) -> Dict[str, List[Dict]]:
        ...
        try:
            ...
            logger.error(f"Error with transformer NER: {str(e)}")
            return {}
